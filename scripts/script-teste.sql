CREATE USER LOGISTICA IDENTIFIED BY oracle;

GRANT CONNECT TO LOGISTICA;

GRANT CONNECT, RESOURCE, DBA TO LOGISTICA;

GRANT CREATE SESSION TO LOGISTICA;

GRANT DBA TO LOGISTICA;

GRANT CREATE VIEW, CREATE PROCEDURE, CREATE SEQUENCE TO LOGISTICA;

GRANT UNLIMITED TABLESPACE TO LOGISTICA;
GRANT CREATE MATERIALIZED VIEW TO LOGISTICA;
GRANT CREATE TABLE TO LOGISTICA;
GRANT GLOBAL QUERY REWRITE TO LOGISTICA;
GRANT SELECT ANY TABLE TO LOGISTICA;
