...
public class ColaboradorController implements ColaboradorControllerDoc {
    ...
    public ResponseEntity<ColaboradorDTO> findById(@RequestParam("idUsuario") Integer idUsuario)
            throws RegraDeNegocioException {
        return new ResponseEntity<>(colaboradorService.listarPorId(idUsuario), HttpStatus.OK);
    }
